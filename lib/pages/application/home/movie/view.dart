...
import 'package:pinker/common/global/resource.dart';
...
class MovieView extends GetView<MovieController> {
  ...
  Widget build(BuildContext context) {
    ...
    final _data = ResourceController.to.homeMoveData;
    ...
    const noChanceDecoration =
        BoxDecoration(color: MyColors.text, borderRadius: MyStyle.borderRadius);
